...
const currentTvList = require('../data/hulu/ratings/tvRatings.json')
const currentMovieList = require('../data/hulu/ratings/movieRatings.json')

// save old ratings
fs.writeFile('../data/hulu/ratings/tvRatings_old.json', JSON.stringify(currentTvList), function (err) {
    if (err) throw err;
    console.log('Saved Old Ratings!');
});

// save old ratings
fs.writeFile('../data/hulu/ratings/movieRatings_old.json', JSON.stringify(currentMovieList), function (err) {
    if (err) throw err;
    console.log('Saved Old Ratings!');
});
...
async function run() {
        ...
        for(t=0;t<length;t++){
            ...
            if ( !currentMovieList.some((ct) => { return ct.href === title.href }) ) {
                ...
                try {
                    ...
                    fs.writeFile('../data/hulu/ratings/movieRatings.json', JSON.stringify(currentMovieList), function (err) {
                        if (err) throw err;
                    ...
                    fs.writeFile('../data/hulu/ratings/movieErrors.json', JSON.stringify(movieErrors), function (err) {
                        if (err) throw err;
   ...
   // save issue list
    fs.writeFile('../data/hulu/ratings/movieIssueList.json', JSON.stringify(movieIssueList), function (err) {
        if (err) throw err;
    ...
    for(k=0;k<tvKeys.length;k++){
        ...
        for(t=0;t<length;t++){
            ...
            if ( !currentTvList.some((ct) => { return ct.href === title.href }) ) {
                ...
                try {
                    ...
                    fs.writeFile('../data/hulu/ratings/tvRatings.json', JSON.stringify(currentTvList), function (err) {
                        if (err) throw err;
                        console.log('Saved Rating!');
                    });
                    ...
                    console.log('Error on: ', title.title)
                    fs.writeFile('../data/hulu/ratings/tvErrors.json', JSON.stringify(tvErrors), function (err) {
                        if (err) throw err;
                        console.log('Saved!');
                    });
                }
        ...
        // save issue list
        fs.writeFile('../data/hulu/ratings/tvIssueList.json', JSON.stringify(tvIssueList), function (err) {
            if (err) throw err;
